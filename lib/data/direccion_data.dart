...
List<Veggie> veggies = [
  Veggie(
    id: 1,
    name: 'Bastión Popular',
    imageAssetPath: 'assets/images/bastion.png',
    category: VeggieCategory.norte,
    ...
    vitaminAPercentage: -2.0842547,
    vitaminCPercentage: -79.9313804,
    servingSize: 'Bastión Popular Blq. 5 Mz. 310',
    caloriesPerServing: ':)',
    trivia: const [
      Trivia(
  ...
  Veggie(
    id: 2,
    name: 'Bahía',
    imageAssetPath: 'assets/images/bahia.png',
    category: VeggieCategory.fruit,
    shortDescription: 'Calixto Romero y Cacique Álvarez.',
    accentColor: const Color(0x408ea26d),
    seasons: [Season.summer],
    vitaminAPercentage: -2.196469,
    vitaminCPercentage: -79.8846019,
  ...
  //   vitaminAPercentage: 10.30,
  //   vitaminCPercentage: 15.30,
  ...
  Veggie(
    id: 4,
    name: 'Mucho Lote 2:',
    imageAssetPath: 'assets/images/mucholote.png',
    category: VeggieCategory.norte,
    shortDescription: 'Macro Lote 2, 3, 8, 9, Autopista Villa España 2.',
    accentColor: const Color(0x40b0ba59),
    seasons: [Season.summer],
    vitaminAPercentage: -2.0839292,
    vitaminCPercentage: -79.9281165,
  ...
  Veggie(
    id: 5,
    name: 'Batallón Suburbio',
    imageAssetPath: 'assets/images/batallon.png',
    category: VeggieCategory.sur,
    shortDescription: 'Calle 40 entre la I y la J.',
    accentColor: const Color(0x409d5adb),
    seasons: [Season.summer],
    vitaminAPercentage: -2.2221471,
    vitaminCPercentage: -79.9366869,
    servingSize: '1 cup',
    caloriesPerServing: ':)',
    trivia: const [
      Trivia(
  ...
  Veggie(
    id: 6,
    name: 'Isla Trinitaria',
    imageAssetPath: 'assets/images/trinitaria.png',
    category: VeggieCategory.sur,
    shortDescription: 'Cooperativa Nuevo Ecuador III Mz. 709 Sl. 12.',
    accentColor: const Color(0x40f6bd56),
    seasons: [Season.summer],
    vitaminAPercentage: -2.2401731,
    vitaminCPercentage: -79.9258625,
